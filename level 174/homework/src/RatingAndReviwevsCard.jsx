...
function RatingAndReviwevsCard({firstName, lastName, review, date, rating}) {
    ...
    return (
        <>
                ...
                <div className='w-[610px] h-[240px] border border-[#0000001A] px-[32px] py-[28px] flex flex-col items-start justify-center gap-[10px] rounded-[20px] shrink-[0] grow-[0] max-sm:w-[100%] mt-[20px] max-lg:w-auto max-lg:h-auto'>
                <section>
                    {
                        arr.map((_, index) => {
